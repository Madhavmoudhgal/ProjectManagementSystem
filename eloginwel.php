<?php 
	...
	$sql1 = "SELECT `tname`, `duedate` FROM `Task` WHERE eid = $id and status = 'Due'";
	...
	<header>
		<nav>
			...
			<ul id="navli">
				...
				<li><a class="homeblack" href="empTask.php?id=<?php echo $id?>"">My Tasks</a></li>
