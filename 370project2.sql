...
INSERT INTO `Task` (`tid`, `eid`, `tname`, `duedate`, `subdate`, `mark`, `status`) VALUES
...
--
ALTER TABLE `Task`
  MODIFY `tid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=226;
...
--
ALTER TABLE `Task`
  ADD CONSTRAINT `Task_ibfk_1` FOREIGN KEY (`eid`) REFERENCES `employee` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
